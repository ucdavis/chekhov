...
class ChecklistsControllerTest < ActionController::TestCase
  ...
  test "should create checklist" do
    assert_difference('Checklist.count') do
      post :create, checklist: { finished: @checklist.finished, public: @checklist.public, started: @checklist.started, template_id: @checklist.template_id, user_id: @checklist.user_id }
    end
  ...
  test "should update checklist" do
    patch :update, id: @checklist, checklist: { finished: @checklist.finished, public: @checklist.public, started: @checklist.started, template_id: @checklist.template_id, user_id: @checklist.user_id }
    assert_redirected_to checklist_path(assigns(:checklist))
  end
