class ChecklistsController < ApplicationController
  ...
  wrap_parameters :checklist, include: [:template_name, :name, :public, :entries_attributes, :ticket_number]
  ...
  private
    ...
    def checklist_params
      ...
      params.require(:checklist).permit(:template_name, :name, :public, :user_id, :started, :finished, :ticket_number, entries_attributes: [:id, :content, :position, :user_id, :checked])
    end
